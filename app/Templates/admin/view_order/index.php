...
var constants = {
    ...
    preview_address: "'.$this->route_address("Previews.api_admin_preview").'",
    ...
    preference_address: "'.$this->route_address("Preferences.admin_api_view").'",
    order_address: "'.$this->route_address("Orders.admin_api_order").'",
