...
namespace Absoft\Line\Api\Controllers;
...
class ApiController extends Controller
{
    ...
    public function route($name, $parameter)
    {
        ...
        if($name == "read"){
            ...
            $response = $this->read($parameter);
            return Route::display("system_templates", "api", $response);

        }
        else if($name == "write"){

            return $this->write($parameter);

        }
        else if($name == "show"){

            return $this->allUsers($parameter);
            ...
            return $this->addNewUser($parameter);

        }
        else if($name == "new_api_user"){
            ...
            return $this->viewUser($parameter);

        }
        else if($name == "edit"){

            return $this->editUser($parameter);

        }
        else if($name == "add_permission"){

            return $this->add_permission($parameter);

        }
        else if($name == "rm_permission"){

            return $this->remove_permission($parameter);

        }
        else if($name == "deactivate"){

            return $this->deactivate($parameter);

        }
        else if($name == "activate"){


            return $this->activate($parameter);

        }
        else if($name == "search"){

            return $this->search($parameter);
            ...
            \ErrorHandler::reportError(
                "Route Not Found!",
                "There is no Route named ApiController.".$name,
                __FILE__." on Line ".__LINE__
            );

            return Route::display("system_templates", "api", ["header" => ["error" => "true"], "data" => []]);
    ...
    public function write($request){
        ...
        return Route::display("system_templates", "api", []);
